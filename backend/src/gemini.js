...
export async function generateCodeWithAI(prompt, codeContext = '', language = 'html') {
  try {
...
Use inline styles, Comic Sans MS font, bright neon colors, marquees, and retro elements.
...
- Include retro GIF-style animations with CSS
